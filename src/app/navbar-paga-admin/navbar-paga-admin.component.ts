...
@Component({
  selector: 'app-navbar-paga-admin',
  templateUrl: './navbar-paga-admin.component.html',
  styleUrl: './navbar-paga-admin.component.css',
})
export class NavbarPagaAdminComponent implements OnInit {
  photoData: string;
  userData: any;
